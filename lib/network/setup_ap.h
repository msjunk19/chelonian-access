...
// static const char* WIFICFG_NVS_NS = "wifi_cfg"; // NVS namespace
...
// constexpr uint8_t PASS_LEN = 64; // bumped from 32 — WPA2 allows up to 63 chars
...
//     strncpy(ssid, s.c_str(), SSID_LEN);
//     ssid[SSID_LEN] = 0;
//     strncpy(pass, p.c_str(), PASS_LEN);
//     pass[PASS_LEN] = 0;
//     return true;
// }
...
//         // Safety check — WPA2 passwords must be 8–63 chars or empty (open network)
...
//         server.begin();
//     } else {
//         // No credentials stored yet — start default setup AP
//         WiFi.softAP("AC_FALLBACK_AP");
//         dnsServer.start(DNS_PORT, "*", WiFi.softAPIP());
//         server.begin();
//     }
